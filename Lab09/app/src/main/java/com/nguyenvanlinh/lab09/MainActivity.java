...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseTracksEdt = findViewById(R.id.TrackOfCourse);
        courseDurationEdt = findViewById(R.id.DurationCourse);
        courseDescriptionEdt = findViewById(R.id.Description);
        courseLv = findViewById(R.id.ListViewCourse);
        addCourseBtn = findViewById(R.id.btnAddCourse);
        listCourseBtn = findViewById(R.id.btnListOfCourse);
